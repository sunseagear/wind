...
insert  into `sys_operation_log`(`id`,`title`,`content`,`log_type`,`create_by`,`create_date`,`request_uri`,`browser`,`os`,`operation_ip`,`operation_name`,`method`,`params`,`msg`,`status`,`tenant_id`) values ('0eb15ae8ffcf313acc1b5c5776caa1be','商品信息','','select',NULL,'2020-07-05 17:00:26','/test/expandtable/expandtable/list','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.test.expandtable.controller.ExpandTableController.list()','{\"page\":[\"1\"],\"limit\":[\"25\"]}',NULL,'1','00000000'),('1a421fc8801215dfaa2b9d06664b8187','商品信息','','select',NULL,'2020-07-05 16:59:38','/test/expandtable/expandtable/list','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.test.expandtable.controller.ExpandTableController.list()','{\"page\":[\"1\"],\"limit\":[\"25\"]}',NULL,'1','00000000'),('2f83dc6fbc3970c8c625a964c9c7acbb','数据权限表','','select',NULL,'2020-07-05 16:58:06','/sys/datarule/list','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.sys.controller.DataRuleController.list()','{\"page\":[\"1\"],\"limit\":[\"25\"]}',NULL,'1','00000000'),('3a99c5ff560b406cd6fb0029d0758295','车辆品牌分组','','select',NULL,'2020-07-05 16:59:20','/test/twotable/car/list','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.test.twotable.controller.CarController.list()','{\"page\":[\"1\"],\"limit\":[\"25\"]}',NULL,'1','00000000'),('3da7b9cabd3ed6d7e927dc91d5f8bfa7','综合表格','','select',NULL,'2020-07-05 16:57:52','/test/table/table/detail/11af6bf658691874d4762267241a71e1','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.test.table.controller.TableController.detail()','{}',NULL,'1','00000000'),('494e53da1b8a32b727e922ca56109a43','综合表格','','update',NULL,'2020-07-05 16:57:59','/test/table/table/update','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.test.table.controller.TableController.update()','{\"id\":[\"11af6bf658691874d4762267241a71e1\"],\"title\":[\"testuser\"],\"content\":[\"<p>testuser</p>\"],\"author\":[\"4028ea815a3d2a8c015a3d2f8d2a0002\"],\"type\":[\"china\"],\"status\":[\"published\"],\"level\":[\"3\"],\"publishDate\":[\"2020-01-26 03:05:00\"],\"createBy\":[\"bf5a446c42964ad6a42b2bbb04604190\"],\"createDate\":[\"2020-01-26 03:06:03\"],\"delFlag\":[\"0\"]}',NULL,'1','00000000'),('50b657d9777eb0fbf7aab64ab7b867bc','商品信息','','select',NULL,'2020-07-05 17:00:28','/test/expandtable/expandtable/list','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.test.expandtable.controller.ExpandTableController.list()','{\"page\":[\"1\"],\"limit\":[\"25\"]}',NULL,'1','00000000'),('7b29316a451bf3a484f4f05528a6835c','树形结构表','','select',NULL,'2020-07-05 16:59:23','/test/treetable/treetable/list','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.test.treetable.controller.TreeTableController.list()','{\"page\":[\"1\"],\"limit\":[\"25\"]}',NULL,'1','00000000'),('b20391830504f5ece3d0a087a499bfca','商品信息','','select',NULL,'2020-07-05 16:59:25','/test/expandtable/expandtable/list','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.test.expandtable.controller.ExpandTableController.list()','{\"page\":[\"1\"],\"limit\":[\"25\"]}',NULL,'1','00000000'),('be865d190bc071aa32aebd9ac79f28b2','用户管理','','select',NULL,'2020-07-05 16:58:00','/sys/user/detail/4028ea815a3d2a8c015a3d2f8d2a0002','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.sys.controller.UserController.detail()','{}',NULL,'1','00000000'),('dd5211a785746fb581eb19532cbb3e3e','用户管理','','select',NULL,'2020-07-05 16:58:00','/sys/user/list','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.sys.controller.UserController.list()','{\"page\":[\"1\"],\"limit\":[\"25\"]}',NULL,'1','00000000'),('e425d18e7702399b676d9faa44d97ad4','综合表格','','select',NULL,'2020-07-05 16:58:00','/test/table/table/list','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.test.table.controller.TableController.list()','{\"page\":[\"1\"],\"limit\":[\"25\"]}',NULL,'1','00000000'),('e8b0d03204d450164f18e3ae643013b5','用户管理','','select',NULL,'2020-07-05 16:57:53','/sys/user/detail/4028ea815a3d2a8c015a3d2f8d2a0002','Chrome 8','Windows 10','127.0.0.1','admin','com.sunseagear.wind.modules.sys.controller.UserController.detail()','{}',NULL,'1','00000000');
...
insert  into `sys_role_data_rule`(`id`,`data_rule_category`,`data_rule_id`,`role_id`) values ('fb7de9d6f0e84b7d1aa81d6d358a6eaf',NULL,'2d1d11805de287aa9b9108350cf45eac','0');
