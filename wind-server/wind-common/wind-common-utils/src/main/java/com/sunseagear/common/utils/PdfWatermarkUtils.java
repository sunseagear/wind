 ...
 * @package com.sunseagear.common.utils
 * @title:
 * @description: PDF加水印 * @date: 2018/6/4 17:10
...
public class PdfWatermarkUtils {
    ...
    public static void setWatermark(String sourcePath,
            ...
            throws IOException, DocumentException {
        byte[] bytes = FileUtils.toByteArray(sourcePath);
        OutputStream outPutStream = FileUtils.openOutputStream(new File(targetPath));
