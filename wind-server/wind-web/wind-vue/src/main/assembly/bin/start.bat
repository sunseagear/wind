...
java -Xms512m -Xmx2048m -server %DEBUG_OPTS% %JMX_OPTS% %CONFIG% -jar ../lib/%APP_NAME%
goto end

:debug
echo "debug"
java -Xms512m -Xmx2048m -server %DEBUG_OPTS% %CONFIG% -jar ../lib/%APP_NAME%
goto end

:jmx
java -Xms512m -Xmx2048m -server %JMX_OPTS% %CONFIG% -jar ../lib/%APP_NAME%
goto end
